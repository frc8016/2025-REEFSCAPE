...
import frc.robot.Constants.Algae_SetPointConstants;
    ...
    private void configureBindings() {
        ...
        m_operatorController.leftTrigger().whileTrue(
                new StartEndCommand(
                        ...
                        () -> m_CoralIntake.runRollers(0),
                        m_CoralIntake));
        m_operatorController.rightTrigger().onTrue(m_AlgaeIntake.goToSetPointCommand(Algae_SetPointConstants.UP));
