...
public class AlgaeIntake extends SubsystemBase {
    ...
    public AlgaeIntake() {
        ...
        m_algaeMotorconfig.closedLoop.maxMotion
                .maxVelocity(AlgaeIntakeConstants.MAX_VEL_RPM)
                .maxAcceleration(AlgaeIntakeConstants.MAX_ACCEL_RPM)
                .positionMode(MAXMotionPositionMode.kMAXMotionTrapezoidal)
                .allowedClosedLoopError(AlgaeIntakeConstants.ALLOWED_SETPOINT_ERROR);
        // sets some softlimits
        m_algaeMotorconfig.softLimit
                .forwardSoftLimit(AlgaeIntakeConstants.ALGAE_FORWORD_SOFTLIMIT)
                .forwardSoftLimitEnabled(true)
                .reverseSoftLimit(AlgaeIntakeConstants.ALGAE_REVERSE_SOFTLIMIT)
